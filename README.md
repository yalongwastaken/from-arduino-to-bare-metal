...
- **ESP-IDF (v5.x+)** — Espressif's native framework. FreeRTOS, proper drivers, no Arduino.h.
...
├── 02-displays/
│   ├── 2.1-hello_led/
│   │   ├── esp-idf/       — ESP-IDF v5.x implementation
│   │   │   ├── main/
│   │   │   │   └── main.c
│   │   │   ├── CMakeLists.txt
│   │   │   └── README.md
...
STM32 translations are added after all ESP-IDF lessons are complete. Each lesson will gain a `stm32/` folder alongside `esp-idf/`.
